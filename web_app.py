...
instructions = "Enter beers that you like using the boxes below. The more beers you add, the better your recommendations will be -- we recommend adding at least 5 beers. When you're done adding all the beers you want, you can choose how many recommendations you want and click \"Get recommendations!\""
overview = "This project was done as part of the Fall 2023 [Erdös Institute](https://www.erdosinstitute.org) Data Science Bootcamp. The recommender works by using matrix factorization on this BeerAdvocate [data set](https://data.world/socialmediadata/beeradvocate). To learn more about the project visit the [github repository](https://github.com/b-butler/beer-recommender-erdos-fall-2023) or our [project summary](https://www.erdosinstitute.org/project-database/fall-2023/data-science-boot-camp/brewsavvy)."
st.write(overview)
